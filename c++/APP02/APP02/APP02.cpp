...
// APP02.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CAPP02App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CAPP02App
...
// El único objeto CAPP02App

CAPP02App theApp;


// Inicialización de CAPP02App

BOOL CAPP02App::InitInstance()
{
